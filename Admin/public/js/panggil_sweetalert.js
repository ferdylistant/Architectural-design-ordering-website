$(document).on('click', '.hapus-perusahaan', function(){
  var getLink = $(this).attr('href');
  swal({
    title: 'Apakah anda yakin?',
    text:  'Pengaturan perusahaan tidak bisa dikembalikan lagi setelah dihapus!',
    type: 'warning',
    html: true,
...
$(document).on('click', '.hapus-rekening', function(){
  var getLink = $(this).attr('href');
  swal({
    title: 'Apakah anda yakin?',
    text:  'Rekening tidak bisa dikembalikan lagi setelah dihapus!',
    type: 'warning',
    html: true,
    confirmButtonColor: '#d9534f',
    showCancelButton: true,
...
$(document).on('click', '.hapus-paket', function(){
  ...
  swal({
    title: 'Apakah anda yakin?',
    text:  'Data paket tidak bisa dikembalikan lagi setelah dihapus!',
    type: 'warning',
    html: true,
    confirmButtonColor: '#d9534f',
    showCancelButton: true,
...
$(document).on('click', '.simpan-paket', function(){
  var getLink = $('.act-save').attr('action');
  swal({
    title: 'Apakah anda yakin?',
    text:  'Periksa kembali jika ada yang belum tepat!',
    type: 'warning',
    html: true,
    confirmButtonColor: '#d9534f',
    showCancelButton: true,
...
$(document).on('click', '.konfirmasi-status', function(e){
...
$(document).on('click', '.hapus-kategori-galeri', function(){
  ...
  swal({
    title: 'Apakah anda yakin?',
    text:  'Kategori portofolio tidak bisa dikembalikan lagi setelah dihapus!',
    type: 'warning',
    html: true,
    confirmButtonColor: '#d9534f',
    showCancelButton: true,
