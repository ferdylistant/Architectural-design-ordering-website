  ...
  <div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body"style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
        <h4 class="card-title"><i class="fa fa-credit-card"></i> EDIT REKENING</h4>                  
        ...
        <?php } ?>
        <form method="post" action="/rekening/update" enctype="multipart/form-data" class="form-horizontal">
        <input type="hidden" name="id_rekening" value="<?php echo $rek['id_rekening'] ?>">
        <input type="hidden" name="gambar_rekening" value="<?php echo $rek['gambar_rekening'] ?>">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Nama Bank</label>
                <div class="col-sm-9">
                  <input type="text" name="nama_bank" class="form-control" placeholder="Nama Bank" value="<?php echo $rek['nama_bank'] ?>">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" placeholder="Nomor Rekening" name="nomor_rekening" value="<?php echo $rek['nomor_rekening']?>">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" placeholder="Atas Nama" name="nama_pemilik" value="<?php echo $rek['nama_pemilik']?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  ...
                  <img id="blah" src="<?= base_url()?>/uploads/rekening/<?= $rek['gambar_rekening']?>" class="rounded img-thumbnail" style="width: 220px">
                </div>                          
              </div>
            </div>
          </div>
