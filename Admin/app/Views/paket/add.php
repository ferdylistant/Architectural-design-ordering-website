...
<div class="col-12 grid-margin">
 <div class="card">
   <div class="card-body" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
     <h4 class="card-title"><i class="fa fa-list-alt"></i>&nbsp;Paket Add</h4>
    ...
    ?>
  <form method="post" action="<?= base_url(); ?>/paket/save" enctype="multipart/form-data" class="form-horizontal">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group row">
        <label class="col-sm-3 col-form-label">Nama Paket</label>
        <div class="col-sm-9">
          <input tipe="text" name="nama_paket" class="form-control" value="<?php echo set_value('nama_paket') ?>">
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
        <select data-placeholder="Select..." name="tipe" class="form-control select2me" value="<?php echo set_value('tipe') ?>">
            <option value=""></option>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" placeholder="" name="ukuran_tanah" value="<?php echo set_value('ukuran_tanah') ?>">
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
        <select data-placeholder="Select..." name="satuan" class="form-control select2me" value="<?php echo set_value('satuan') ?>">
            <option value=""></option>
    ...
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" placeholder="" name="harga" value="<?php echo set_value('harga') ?>">
        </div>
      </div>
    </div>
  </div>
