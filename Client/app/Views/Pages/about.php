		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 intro-text">
					<h1>We are a creative Design<span>Studio</span></h1>
					<div class="row">
						<div class="col-md-12">
				...
				<div class="col-lg-4 pt-4">
					<img class="img-fluid" src="http://admin.desainrumah.com/uploads/perusahaan/<?= $company['logo']?>" alt="">
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-9 promo-text">
					<h1>Anda butuh <span>desain</span> rumah?</h1>
					<p>Segera pilih paket desain rumah terbaikmu untuk rumah impian masa depan...</p>
				</div>
				<div class="col-lg-3 text-lg-right">
					<a href="<?= base_url()?>/package" class="site-btn sb-dark mt-4">Order Desain</a>
				</div>
			</div>
		</div>
	</section>
