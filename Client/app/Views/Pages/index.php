		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 intro-text mb-5 mb-lg-0">
					<h2 class="sp-title">We are a creative Design<span>Studio</span></h2>
				...
				<div class="col-lg-7 pl-lg-0 offset-lg-5 cta-content">
					...
					<div class="cta-icons">
						<div class="cta-img-icon">
							<img src="assets/img/icon/light/1.png" alt="">
						</div>
						<div class="cta-img-icon">
							<img src="assets/img/icon/light/2.png" alt="">
						</div>
						<div class="cta-img-icon">
							<img src="assets/img/icon/color/3.png" alt="">
						</div>
					</div>
				</div>
			</div>
	...
	<div class="projects-section pb50">
		...
		<div id="projects-carousel" class="projects-slider">
			<div class="single-project set-bg rest" data-setbg="assets/img/projects/1.jpg">
			...
			<div class="single-project set-bg build" data-setbg="assets/img/projects/2.jpg">
				<div class="project-content">
			...
			<div class="single-project set-bg apart" data-setbg="assets/img/projects/3.jpg">
				<div class="project-content">
			...
			<div class="single-project set-bg rest" data-setbg="assets/img/projects/4.jpg">
				<div class="project-content">
					<h2>Biggest <br> Restaurations</h2>
					<p>Jan 19, 2018</p>
					<a href="#" class="seemore">See Project </a>
			...
			<div class="single-project set-bg apart" data-setbg="assets/img/projects/2.jpg">
				<div class="project-content">
					<h2>Office <br> Building</h2>
					<p>Jan 19, 2018</p>
					<a href="#" class="seemore">See Project </a>
