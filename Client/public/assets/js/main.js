...
(function($) {
	...
	/*[ Modal Lupa Password]
    ===========================================================*/
    var srcOld = $('.forget-password').children('div').attr('class');

    $('[data-target="#lupaPass"]').on('click',function(){
        $('.forget-password').children('div')[0].class += "panel-body";

        setTimeout(function(){
            $('.forget-password').css('opacity','1');
        },300);      
    });

    $('[data-dismiss="modal"]').on('click',function(){
        $('.forget-password').children('div')[0].class += srcOld;
        $('.forget-password').css('opacity','0');
    });
